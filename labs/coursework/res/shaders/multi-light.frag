...
vec4 calculate_point(in point_light point, in material mat, in vec3 position, in vec3 transformed_normal, in vec3 view_dir,
                     in vec4 tex_colour) {
  // *********************************
...
vec4 calculate_spot(in spot_light spot, in material mat, in vec3 position, in vec3 transformed_normal, in vec3 view_dir,
                    in vec4 tex_colour) {
  // *********************************
